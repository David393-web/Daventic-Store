...
import background from "../../assets/women/women3.png";
import logo from "../../assets/Logo.png";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import axios from "axios";
import Sliding from "../../Reusable/AuthSlider";
...
const Forgotpasswordmessage = () => {
  ...
  const handleResendEmail = async () => {
    ...
    } catch (error) { // Removed ': unknown' type annotation
      toast.error(
        error?.message || "Failed to resend reset link", // Removed '(error as Error)' cast
        {
          position: "top-right",
          autoClose: 4000,
        }
