    ...
    <div className="grid min-h-screen grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col items-center justify-center px-8 py-12">
        <div className="w-full max-w-md">
          <h2 className="mb-4 text-3xl font-bold text-primary">Create Account</h2>
          <p className="mb-8 text-sm text-gray-600 dark:text-gray-300">
            Welcome to Daventic — Let’s get you started.
          </p>
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 text-white transition-all rounded-md bg-primary hover:bg-orange-600"
            >
              Sign Up
            </button>
          </form>
