...
import BannerImg from "../../assets/women/women5.png"
...
const Banner = () => {
    return (
        <div className='min-h-[550] flex justify-center items-center py-12 sm:py-0 mt-20 mb-20'>
            ...
            gap-6 items-center'>
                    ...
                    <div>
                        <img src={BannerImg}
                         ...
                         max-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)]
                          object-cover'/>
                    </div>
                    ...
                    <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                        <h1 data-aos="fade-up"
                        className='text-3xl:text-4xl font-bold'
                        >Winter Sale upto 50% off</h1>
                        <p  data-aos="fade-up" className='text-sm text-gray-500
                        tracking-wide leading-5'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                             Ratione cumque optio asperiores sequi praesentium
                              corporis facere similique voluptates neque officia?
                        </p>
